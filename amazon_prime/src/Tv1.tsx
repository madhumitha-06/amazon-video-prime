...
function Tv1(props:any){
    return(
      ...
      <div className="moviecard1">
        ...
        <p className="title">{props.parent.title}</p>
        <p className="id">{props.parent.id}</p>
        <div className="whole">
        ...
        <p className="release">
          {props.parent.year}
          <span className="time">{props.parent.time}</span>
        </p>
        <div className="whole1">
          <p className="age">{props.parent.age}</p>
          <p className="age1"><FontAwesomeIcon icon={faCameraRetro}/></p>
        </div>
        <p className="description">{props.parent.description}</p>
      </div>
    </div>
        </>
    )
