...
import mov3 from './assets/images/watch1.png'
import mov4 from './assets/images/remote.png'
import mov5 from './assets/images/watch3.png'
import mov6 from './assets/images/watch4.png'
import mov7 from './assets/images/watch5.png'
import mov8 from './assets/images/watch6.png'
import mov9 from './assets/images/watch7.jpg'
import mov10 from './assets/images/watch8.jpg'
        ...
        <>
            <div className='watchanydiv'>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Smart TV or Blu-Ray Player</h6>
                        <ol>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Streaming Media Player</h6>
                        <ol>
                        ...
                        <p style={{ fontSize: 'large', marginLeft: '30px' }} className='locatespan'>Sign in to your Amazon account and enter your code</p>
                    </div>
                </div>
                <div className='side'>
                    <img className='sideimg' src={mov5} alt="" />
                    <div>
                        <h6 className='stream'>Game console</h6>
                        <ol>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Fire Tablet</h6>
                        <ol>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>iOS Phone or Tablet</h6>
                        <ol>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Android Phone or Tablet</h6>
                        <ol>
                            <li> If the Amazon Prime Video app isn't pre-installed on your Smart TV or Blu-ray player, download it from your device's app store.</li>
                            <li> Open the Amazon Prime Video app and sign in with your Amazon Prime or Prime Video account.</li>
                            <li> Choose a movie or TV Show and start streaming.</li>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Google Chromecast</h6>
                        <ol>
                ...
                <div className='side'>
                    ...
                    <div>
                        <h6 className='stream'>Windows PC or Tablet</h6>
                        <ol>
                ...
                <div className='footer footer1 foot helpfoot' >
