    ...
    return (
        <>
            <div className='helper'>
                <div style={{ height: '50px', width: '100%', backgroundColor: "rgba(209, 229, 236, 1)", paddingLeft: '50px', paddingTop: '5px', fontSize: 'x-large', fontWeight: 'bold' }}>
                    <p>Help</p>
                </div>
                ...
                <div className='help'>
                    <div className='class1'>
                        <p style={{ paddingTop: '5px', paddingBottom: '5px',fontWeight:"600",fontSize:"25px" }}>Setting</p>
                    ...
                    <div className='class2'>
                        ...
                        <div style={{ backgroundColor: 'lightgrey', fontSize: 'x-small', height: '90px', width: '340', marginTop: '59px',paddingTop:"10px" }}>
                    ...
                    <div className='class1 class3'>
                        <p style={{ paddingTop: '5px', paddingBottom: '5px',fontWeight:"600",fontSize:"25px" }}>Popular Articles</p>
                ...
                <div style={{ height: '90px', width: '100%', backgroundColor: "rgba(209, 229, 236, 1)", marginTop: '30px', display: 'flex', paddingLeft: '200px', paddingTop: '10px', gap: '20px',borderTop:"1px solid grey" }}>
